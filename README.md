...
A competivite typing application with a containerized Java/Spring Boot API, React frontend, and PostgreSQL database. Features real-time WPM tracking, session analytics, and leaderboards. Deployed to AWS via CI/CD with GitHub Actions.
